"""
Local Code Review Agent - CustomTkinter Desktop Application

A privacy-first Python desktop app that reviews Python code using a
two-pass LLM agent (broad review + targeted verification). Fully offline.
...
class CodeReviewApp(ctk.CTk):
    ...
    def _create_sidebar(self):
        ...
        self.sidebar = ctk.CTkFrame(
            self, width=280, corner_radius=0, fg_color=COLORS["bg_secondary"]
        )
        ...
        about_text = ctk.CTkLabel(
            ...
            text=(
                ...
                "• 🔍 Broad pass: audits all bug categories\n"
                "• 🔒 Verification pass: hunts credentials,\n"
                "   bare except, O(n²), weak crypto,\n"
                "   and timing attacks\n"
    ...
    def _create_input_field(
        self, label: str, attr_name: str, default: str, placeholder: str, parent
    ):
    ...
    def _create_header(self):
        ...
        title_icon = ctk.CTkLabel(title_row, text="🔍", font=ctk.CTkFont(size=32))
        title_icon.pack(side="left")

        title_text = ctk.CTkLabel(
            title_row,
            text="Local Code Review Agent",
...
greet("World")"""
    ...
    def _create_results_area(self):
        ...
        # Configure tab grids
        for tab in [self.review_tab, self.exec_tab]:
    ...
    def _create_review_tab(self):
        ...
        self.review_content = ctk.CTkLabel(
            scroll,
            text="No review yet. Enter code and click 'Review Code' to start.",
            font=ctk.CTkFont(size=13),
            text_color=COLORS["text_secondary"],
            wraplength=800,
            justify="left",
    ...
    def _start_review(self):
        ...
        # Start processing
        self._set_processing(True, "Running two-pass review...")
    ...
    def _run_agent_thread(self, code: str):
        ...
        try:
            ...
            self.after(
                0,
                lambda: self.loading_label.configure(text="Running two-pass review..."),
            )
    ...
    def _update_results(self, state: AgentState):
        """Update result tabs with agent state."""
    ...
    def _update_execution_tab(self, state: AgentState):
        ...
        if result:
            if result.success:
                ...
                self.exec_status_label.configure(
                    text="❌ Execution failed", text_color=COLORS["accent_red"]
                )
    ...
    def _update_execution_only(self, result):
        ...
        if result.success:
            ...
            self.exec_status_label.configure(
                text="✅ Code executed successfully!", text_color=COLORS["accent_green"]
            )
        else:
